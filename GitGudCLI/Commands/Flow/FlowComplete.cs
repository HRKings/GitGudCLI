...
{
	public class FlowCompleteSettings : CommandSettings
	{
		[CommandOption("[BranchName]")]
		public string BranchName { get; set; }
	}
	
	public class FlowComplete : Command<FlowCompleteSettings>
	{
		public override int Execute(CommandContext context, FlowCompleteSettings options)
		{
			...
			var response = flowHelper.Complete(options.BranchName);
