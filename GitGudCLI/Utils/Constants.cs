namespace GitGudCLI.Utils
{
    public static class Constants
    {
        ...
        public static readonly string[] VALID_COMMIT_TAGS =
            {
                "feature",
                "change",
                "fix",
        ...
        public static readonly string[] COMMIT_TAGS_DESCRIPTIONS =
            {
        ...
        public static readonly string[] VALID_COMMIT_FLAGS = { "!!!", "db", "api", "ux", "dpc", "rm", "wip" };

        public static readonly string[] COMMIT_FLAGS_DESCRIPTIONS =
            {
        ...
        public static readonly string[] VALID_WORKING_BRANCH_TYPES = { "wip/", "fix/", "chore/", "hotfix/" };

        public static readonly string[] VALID_WORKING_BRANCH_TYPE_DESCRIPTIONS =
            {
